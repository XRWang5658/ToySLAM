...
namespace gnss_comm
{
    ...
    *-----------------------------------------------------------------------------*/
    ...
    /* lamda reduction (z=Z'*a, Qz=Z'*Q*Z=L'*diag(D)*L) (ref.[1]) ---------------*/
     void reduction(int n, double *L, double *D, double *Z);


    /* modified lamda (mlamda) search (ref. [2]) -------------------------------*/
     int search(int n, int m, const double *L, const double *D,
                    const double *zs, double *zn, double *s);


    /* lamda/mlamda integer least-square estimation ------------------------------
    * integer least-square estimation. reduction is performed by lamda (ref.[1]),
    * and search by mlamda (ref.[2]).
    ...
    *-----------------------------------------------------------------------------*/
     int lamda(int n, int m, const double *a, const double *Q, double *F,
                    double *s);
     int lamda_dk(int n, int m, const double *a, const double *Q, double *F,
               double *s);
